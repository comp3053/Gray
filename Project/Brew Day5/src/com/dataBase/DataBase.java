...
public class DataBase {
	...
	// Get last brewing
	public static Brew getLastBrewing() throws LargerThanEquip, SQLException, ParseException {
	...
	// Get all brew information
	public static ArrayList<Brew> getAllBrewInformationWithoutNote() throws SQLException, LargerThanEquip, ParseException {
	...
	public static ArrayList<Brew> getBrewWithNoteWritten() throws SQLException, LargerThanEquip, ParseException {
		ArrayList<Brew> brewList = new 	ArrayList<Brew>();
		Connection conn = DBConnection.getConnection();
		Statement stmt = conn.createStatement();
	...
	// Updating storage ingredient with name
	...
	// Getting all storage ingredient
	...
	// Check the all the recipe with satisfied recipe capacity
	...
	// Check single recipe satisfaction
	...
	// Get the missing ingredient capacity from the recipe and storage calculation
