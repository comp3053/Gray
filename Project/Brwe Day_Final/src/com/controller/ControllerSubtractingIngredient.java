...
public class ControllerSubtractingIngredient {
	StorageIngredient storIngredient;
	public ControllerSubtractingIngredient() {
		
	}
	// This is the method for controller to subtracting ingredient
	public String conSubtractingIngredient(String maltT,String hopT,String yeastT,String sugarT,String additiveT) throws SQLException {
		//set new storIngredient
		...
		if(check1==3 || check2==3 || check3==3 || check4==3 || check5==3 ) {
			...
			String get = storIngredient.checkForUpdating(maltT,hopT,yeastT,sugarT,additiveT,0);
				return get;
		}
	}
}
